...
import { FaEdit, FaImage, FaRegArrowAltCircleDown, FaTrash } from "react-icons/fa";
          ...
          <div className="w-full p-4 bg-[#6a5fdf] rounded-md ">
            <div className="flex justify-between items-center ">
              <select
                ...
                className="px-4 py-2 focus:border-[#ffffff] outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
              >
                    ...
                    <tr key={index}>
                      ...
                      >
                        <img
                          ...
                          src={`http://localhost:5173/images/category/${data}.jpg`}
                          alt=""
                        />
                      </td>
                      <td
            ...
            <div className="bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
              ...
              <form>
                ...
                <div>
                  ...
                  <div>
                    <button className="bg-red-500 w-full hover:shadow-red-500/40 hover:shadow-md text-[#fff] rounded-md px-7 py-2 mt-3">Add Cateogry</button>
                  </div>
                </div>
              </form>
            </div>
